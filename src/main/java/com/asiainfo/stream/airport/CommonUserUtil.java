...
//        System.out.print(String.format("统计生成%d小时，%d天；", hours, days));
...
//                System.out.println("new common user file: " + userFile.getAbsolutePath() + ": " + created);
    ...
    public static void main(String[] args) {
        ...
        try {
            new CommonUserUtil().generateCommonUserData("100001000002831", TimeUtil.getTime(startDateStr), TimeUtil.getTime(endDateStr), 2L);
